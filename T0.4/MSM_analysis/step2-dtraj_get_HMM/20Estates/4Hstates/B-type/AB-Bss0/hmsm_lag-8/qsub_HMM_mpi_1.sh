...
WD=$PWD
cd /usr/scratch && mkdir rudzinski && cd rudzinski
mkdir $JOB_ID && cd $JOB_ID
cp $WD/* ./
echo Starting simulation in $PWD

/home/theorie/rudzinski/soft/anaconda/envs/PyEmma-new/bin/mpiexec -n 8 /home/theorie/rudzinski/soft/anaconda/envs/PyEmma-new/bin/python Get_HMM_AB-Bss0.py
result=$?
